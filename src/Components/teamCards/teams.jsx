              ...
              <div className="teams-tabs">
                <ul class="nav nav-pills mb-3" id="pills-tab" role="tablist">
                  <li class="nav-item" role="presentation">
                    <button class="nav-link active" id="pills-home-tab" data-bs-toggle="pill" data-bs-target="#pills-team23" type="button" role="tab" aria-controls="pills-home" aria-selected="true">2022-2023</button>
                  </li>
                  <li class="nav-item" role="presentation">
                ...
                <div class="tab-content" id="pills-tabContent">
                  <div class="tab-pane fade show active" id="pills-team23" role="tabpanel" aria-labelledby="pills-home-tab" tabindex="0">
                    <CardList23 />
                  </div>
